...
export function FigmaIcon({ className = "w-5 h-5" }) {
  return (
    <svg className={className} viewBox="0 0 38 57" fill="currentColor">
      ...
      <path fill="#1ABCFE" d="M38 28.5a9.5 9.5 0 1 1-9.5-9.5H38v9.5z"/>
      <path fill="#0ACF83" d="M0 28.5A9.5 9.5 0 0 1 9.5 19H19v9.5A9.5 9.5 0 0 1 9.5 38 9.5 9.5 0 0 1 0 28.5z"/>
    </svg>
  );
}
