        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-3">
            <button
              ...
              className="text-xs font-semibold text-slate-600 hover:text-slate-900 px-3.5 py-2 rounded-full border border-slate-200 hover:border-slate-300 bg-white hover:bg-slate-50 transition-all duration-200"
            >
              Resume / CV
            </button>
            <a
            ...
            <div className="max-w-7xl mx-auto px-4 py-6 flex flex-col gap-3">
              ...
              <div className="pt-4 border-t border-slate-100 flex flex-col gap-2.5">
                <button
                  ...
                  className="w-full py-3 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-800 font-semibold text-center text-sm transition-colors"
                >
                  Download CV
                </button>
                <a
